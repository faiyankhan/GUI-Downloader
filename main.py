# Creating a GUI Downloader Using Python .
...
class Downloader:
    ...
    def download(self):
        ...
        totle_size_in_bytes = 100
        if(response.headers.get("content-length")):
            totle_size_in_bytes = int(response.headers.get("content-length"))
        ...
        with open(self.saveto, "wb") as f:
            for data in response.iter_content(block_size):
                self.progress_bar["value"] += (100*block_size)/totle_size_in_bytes
